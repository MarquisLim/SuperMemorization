    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_review_date', models.DateField(default=datetime.datetime.now)),
                ('next_review_date', models.DateField(default=datetime.datetime.now)),
                ('deck_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cards', to='Card.deck')),
            ],
        ),
    ]
