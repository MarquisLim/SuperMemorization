"""
Django settings for SuperMemorization project.
...
SECRET_KEY = 'django-insecure--!b=8^f$zbm6u(ube@7$3)e%+=n4v^n%ys*90+&#4iw=tql%%('
...
WSGI_APPLICATION = 'SuperMemorization.wsgi.application'
